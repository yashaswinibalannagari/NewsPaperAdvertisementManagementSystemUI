...
@Component({
  ...
  styleUrls: ['./allads.component.scss']
})
export class AlladsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this._advertisementService.getAdvertisements().subscribe((advertisement) => { this.advertisements = advertisement; console.log(advertisement) }, (errMsg) => { this.errMsg = errMsg });
